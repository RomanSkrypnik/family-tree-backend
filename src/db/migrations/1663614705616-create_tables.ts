...
export class createTables1663614705616 implements MigrationInterface {
    name = 'createTables1663614705616'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`couples\` (\`id\` int NOT NULL AUTO_INCREMENT, \`user1Id\` int NOT NULL, \`user2Id\` int NOT NULL, UNIQUE INDEX \`REL_65ce4e61aa7d00d9a2a528b049\` (\`user1Id\`), UNIQUE INDEX \`REL_888a1eaba963de74fd8aebcd0c\` (\`user2Id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`children\` (\`id\` int NOT NULL AUTO_INCREMENT, \`coupleId\` int NOT NULL, \`memberId\` int NOT NULL, UNIQUE INDEX \`REL_a26609f2457211e93ecd652eee\` (\`memberId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
