...
export class createTables1663678654432 implements MigrationInterface {
    name = 'createTables1663678654432'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`children\` (\`id\` int NOT NULL AUTO_INCREMENT, \`parentId\` int NOT NULL, \`userId\` int NOT NULL, UNIQUE INDEX \`REL_b65f0ac2a8c620dc69f8d75a4f\` (\`parentId\`), UNIQUE INDEX \`REL_045e714a8906182cae37c8dab8\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`children\` ADD CONSTRAINT \`FK_045e714a8906182cae37c8dab89\` FOREIGN KEY (\`userId\`) REFERENCES \`members\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_b65f0ac2a8c620dc69f8d75a4f\` ON \`children\``);
